 ...
 *
 */
package com.minhdtb.storm.core.lib.lib60870;
...
public class ServerSap {
     ...
     *
     * @param connectionListener the ServerConnectionListener that will be notified when remote clients are connecting or the server
     *                           stopped listening.
     */
     ...
     *
     * @param port               the TCP port that the server will listen on. IEC 60870-5-104 usually uses port 2404.
     * @param connectionListener the ServerConnectionListener that will be notified when remote clients are connecting or the server
     *                           stopped listening.
     */
    ...
    public void startListening() throws IOException {
        ServerThread serverThread = new ServerThread(serverSocketFactory.createServerSocket(port, backlog, bindAddr),
