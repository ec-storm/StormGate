...
import com.minhdtb.storm.core.lib.lib60870.APdu.APCI_TYPE;
...
public class Connection {
                        ...
                        switch (aPdu.getApciType()) {
                            case I_FORMAT:
                                ...
                                if (aSduListener != null) {
                                    executor.execute(() -> aSduListener.newASdu(aPdu.getASdu()));
                                }
    ...
    private void resetMaxIdleTimeTimer() {
        ...
        maxIdleTimeTimerFuture = maxIdleTimeTimer.schedule(() -> {
